...
export default function Footer() {
	const phrase = ["WHY", "RUN","ALONE?"];
	const phrase1 = ["FOR","COLLABORATIONS"];
	return (
		<footer className="w-full min-h-screen padding-x z-30 relative pt-[50px] bg-background flex flex-col justify-between rounded-t-[20px] mt-[-20px]">
			<div className="w-full flex justify-between sm:flex-col xm:flex-col">
				...
				<div className="h-full flex flex-col justify-between sm:w-full xm:w-full w-1/2">
					<div>
						<h1 className="mt-6 text-[70px] leading-[55px] lg:text-[130px] lg:leading-[98px] md:text-[100px] md:leading-[75px] sm:text-[74px] sm:leading-[68px] xm:text-[64px] xm:leading-[48px] font-semibold font-FoundersGrotesk text-secondry uppercase">
							...
							<div className="pt-[50px]">
								...
								<div className="flex flex-col gap-y-[10px]">
									<LinkHover
										...
										title={`202-1965 W Mohali, CHANDIGARH`}
										href="/"
									/>
									<LinkHover
										className="before:h-[1px] after:h-[1px] w-fit paragraph font-medium  capitalize flex flex-col before:bottom-[1px] after:bottom-[1px]"
